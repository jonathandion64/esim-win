...
{p_html}
  ...
  <script>
    ...
    document.getElementById('buy-now-btn').addEventListener('click', function() {{
      ...
      // Cross-domain: dispatch mousedown so GA4 native linker decorates href with _gl token.
      var url = selectedUrl;
      var tmpA = document.createElement('a');
      tmpA.href = url;
      document.body.appendChild(tmpA);
      tmpA.dispatchEvent(new MouseEvent('mousedown', {{ bubbles: true }}));
      setTimeout(function() {{
        var finalUrl = tmpA.href;
